...
`data/uiuc_campus/osm_buildings_2026.geojson`) run against the same 2019 LiDAR truth
(`src/vgi_comparison.py data/uiuc_campus/osm_buildings_2026.geojson osm2026`), plus a per-building
