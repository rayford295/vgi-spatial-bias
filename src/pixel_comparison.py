...
OUT = os.path.join(ROOT, "results", "uiuc_campus", "comparison", "pixel"); os.makedirs(OUT, exist_ok=True)
LIDAR = os.path.join(ROOT, "results", "uiuc_campus", "detection", "buildings.geojson")
